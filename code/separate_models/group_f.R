...
train = h2o.importFile(path = 'data/group_f/train.csv')
valid = h2o.importFile(path = 'data/group_f/valid.csv')
...
#########################################################################
# Save the model
path <- h2o.saveModel(model_deep, path="models_server/separate_models/group_f", force=TRUE)
