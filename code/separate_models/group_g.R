...
ttrain = h2o.importFile(path = 'data/group_g/train.csv')
valid = h2o.importFile(path = 'data/group_g/valid.csv')
...
#########################################################################
# Save the model
path <- h2o.saveModel(model_deep, path="models_server/separate_models/group_g", force=TRUE)
